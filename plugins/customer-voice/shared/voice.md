...
**Answer the question they asked, not the question you researched.** If the customer already understands something (e.g., they assumed programmatic API usage), don't explain it back to them. Address their actual concerns, not the question you wish they'd asked. When you've done deep research on a topic, resist the urge to dump all of it into the draft. If the customer asked about the UI, don't explain the backend plumbing. Cut implementation details that don't affect their decision-making. This is the most common drafting mistake.
