> **Source:** Ported from walkinglabs/learn-harness-engineering harness-creator (MIT). Adapted to skill-forge.
...
async function dispatchHook(hookType: HookType, context: HookContext): Promise<HookResult[]> {
